// App-side Transfer Pak glue for PocketMonstersStadiumRecomp.
//
// The Game Boy cart model + the Transfer Pak accessory HLE live in the shared
// engine (librecomp::gbcart + gbpak.cpp + si_joybus.cpp). This file is just the
...
// each cart with librecomp::gbcart. PMS-J's custom block loop reaches the shared
// model via the __osSiRawStartDma joybus processor. See
